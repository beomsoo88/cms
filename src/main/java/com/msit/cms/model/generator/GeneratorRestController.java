...
public class GeneratorRestController {
	...
	@RequestMapping(value = "/ServiceImpl", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> ServiceImpl(@RequestParam Map<String, Object> input) throws Exception {
		Map<String, Object> returns = new HashMap<String, Object>();
		...
		GeneratorUtil.generateServiceImpl(input, textIfce, textImpl);
